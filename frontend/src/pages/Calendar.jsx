        ...
        <main className="flex-1 p-4 sm:p-6 lg:p-8">
          <header className="flex items-center justify-between border-b border-slate-200 pb-4">
            <div>
              ...
              <h2 className="text-3xl font-bold tracking-tight text-indigo-700">{format(month, 'MMMM yyyy')}</h2>
            </div>
            ...
            <div>
              <div className="mb-4 flex flex-wrap items-center justify-between gap-3 rounded-xl border border-slate-200 bg-white p-3">
                <div className="inline-flex rounded-lg bg-slate-100 p-1 text-sm">
                  <button type="button" className="rounded-md bg-white px-3 py-1.5 font-semibold text-indigo-700 shadow-sm">
                    Month
                  </button>
                  <button type="button" className="rounded-md px-3 py-1.5 font-medium text-slate-500 hover:bg-white hover:text-slate-800">
                    Week
                  </button>
                  <button type="button" className="rounded-md px-3 py-1.5 font-medium text-slate-500 hover:bg-white hover:text-slate-800">
                    Day
                ...
                <p className="text-sm font-bold uppercase tracking-[0.16em] text-slate-700">{format(month, 'MMMM yyyy')}</p>
              </div>
